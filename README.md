...
Bem-vindo(a) ao projeto da **Experiência Prática III**!  
Esta aplicação foi desenvolvida em **JavaScript Avançado**, com manipulação do **DOM**, uso de **LocalStorage** e implementação de uma **SPA (Single Page Application)** simples e funcional.
